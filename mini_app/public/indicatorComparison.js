document.addEventListener("DOMContentLoaded", () => {
  ...
  const renderChart = async (country, indicator1, indicator2) => {
    try {
  ...
  const defaultCountry = document.getElementById("country").value;
  const defaultIndicator1 = document.getElementById("indicator1").value;
  const defaultIndicator2 = document.getElementById("indicator2").value;
  renderChart(defaultCountry, defaultIndicator1, defaultIndicator2);
  ...
  document.getElementById("compareButton").addEventListener("click", () => {
    ...
    renderChart(country, indicator1, indicator2);
  });
});
